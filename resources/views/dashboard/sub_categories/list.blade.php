            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ url('dashboard/sub_categories/create ')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; ADD NEW</a>
                        </div>
                    </div>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#subcategory_table').DataTable({
                    //stateSave: true,
                    ...
                    "fnDrawCallback": function (oSettings) {
                        ...
                        $('body').off('click', '[id^="changeStatus-"]').on('click', '[id^="changeStatus-"]', function (e) {
                            var self = $(this);
                            var tbl = "<?php echo 'sub_categories' ?>";
