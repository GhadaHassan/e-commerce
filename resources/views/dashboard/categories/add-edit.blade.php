        ...
        <div class="box box-primary box-solid">
          <div class="box-header box-header-background with-border">
            ...
            <div class="box-tools pull-right">
              <a href="{{ url('dashboard/categories') }}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-angle-double-left"></i>&nbsp; BACK</a>
            </div>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
            <div class="box-body">
              <form role="form" id="addEditUser" action="{{route('categories.store')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}

                <input type="hidden" name="categoryId" value="{{ (!empty($result->id))?($result->id):('') }}">
