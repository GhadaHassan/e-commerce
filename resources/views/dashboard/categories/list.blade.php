            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ url('dashboard/categories/create ')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; ADD NEW</a>
                        </div>
                    </div>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#category_table').DataTable({
                    //stateSave: true,
